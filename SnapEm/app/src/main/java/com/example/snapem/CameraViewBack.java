...
public class CameraViewBack extends Activity implements SurfaceHolder.Callback,
		OnClickListener {
		...
		public void onPictureTaken(byte[] data, Camera camera) {
			if(data != null) {
				...
				try {
					...
					File f = new File(myDir, System.currentTimeMillis() + "-2Backcam.jpg");
					...
					SendToserver.back= String.valueOf(f);
